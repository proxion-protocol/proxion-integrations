...
# Drive B: for Changedetection Data
MOUNT_POINT = "P:" 
POD_PATH = "/stash/" 
...
def start_docker():
    ...
    print("[Proxion] Starting Changedetection Stack...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping Changedetection Stack...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] Changedetection.io is RUNNING at http://localhost:8091")
        print(f"Proxion Monitor: {MOUNT_POINT} (Pod) -> /datastore (Docker)")
