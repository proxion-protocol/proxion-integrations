...
def start_docker():
    """Start Gitea."""
    print("[Proxion] Starting Gitea Stack...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping Gitea Stack...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] Gitea is RUNNING at http://localhost:3000")
        print(f"Proxion Development: {MOUNT_POINT} (Pod) -> /data (Docker)")
