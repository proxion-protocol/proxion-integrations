...
def start_docker():
    """Start Ghost."""
    print("[Proxion] Starting Ghost Stack...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping Ghost Stack...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] Ghost is RUNNING at http://localhost:8089")
        print(f"Proxion Publishing: {MOUNT_POINT} (Pod) -> /content (Docker)")
