...
def start_docker():
    """Start Calibre-Web."""
    print("[Proxion] Starting Calibre-Web...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping Calibre-Web...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] Calibre-Web is RUNNING at http://localhost:8083")
        print(f"Proxion Library: {MOUNT_POINT} (Pod) -> /books (Docker)")
