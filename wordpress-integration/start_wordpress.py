...
def start_docker():
    """Start WordPress."""
    print("[Proxion] Starting WordPress Stack...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping WordPress Stack...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] WordPress is RUNNING at http://localhost:8087")
        print(f"Proxion Web Content: {MOUNT_POINT} (Pod) -> /wp-content (Docker)")
