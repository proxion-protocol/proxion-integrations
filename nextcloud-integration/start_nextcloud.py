...
def start_docker():
    """Start Nextcloud."""
    print("[Proxion] Starting Nextcloud Stack...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping Nextcloud Stack...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] Nextcloud is RUNNING at http://localhost:8085")
        print(f"Proxion Collaboration: {MOUNT_POINT} (Pod) -> /data (Docker)")
