...
def start_docker():
    """Start Vaultwarden."""
    print("[Proxion] Starting Vaultwarden...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping Vaultwarden...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] Vaultwarden is RUNNING at http://localhost:8086")
        print(f"Proxion Secrets: {MOUNT_POINT} (Pod) -> /data (Docker)")
