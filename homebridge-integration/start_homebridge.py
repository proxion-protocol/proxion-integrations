...
def start_docker():
    """Start Homebridge."""
    print("[Proxion] Starting Homebridge...")
    subprocess.run(["docker-compose", "up", "-d"], check=True)

def stop_docker():
    print("[Proxion] Stopping Homebridge...")
...
def main():
    ...
    try:
        ...
        print("\n[Proxion] Homebridge is RUNNING at http://localhost:8581")
        print(f"Proxion IoT Bridge: {MOUNT_POINT} (Pod) -> /homebridge (Docker)")
